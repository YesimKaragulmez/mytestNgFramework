...
public class GlbRegistrationTest extends TestBase {
    /*  When user try to register with valid credentials
        Then user should see "Success!"  message
        Step1:Create page class under pages package: GlbRegisterPage
        Step2:Find the page webelements
        Step3:Create test class under smoke test: GlbRegistrationTest
    */
    @Test
