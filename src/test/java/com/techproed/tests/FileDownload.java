...
public class FileDownload extends TestBase {
    ...
    public void downloadTest() throws InterruptedException {
        ...
        Thread.sleep(3000);//this is not recommended because it is not dynamic ,what hard wait means is,
        //it will wait 5 seconds no matter what.
        //for example ,if an element found in 2 seconds ,you will
